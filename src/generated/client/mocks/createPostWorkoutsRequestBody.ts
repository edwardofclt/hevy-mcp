...
export function createPostWorkoutsRequestBody(data?: Partial<PostWorkoutsRequestBody>): PostWorkoutsRequestBody {
  ...
  return {
  ...{"workout": {"title": faker.string.alpha(),"description": faker.string.alpha(),"start_time": faker.string.alpha(),"end_time": faker.string.alpha(),"is_private": faker.datatype.boolean(),"exercises": faker.helpers.multiple(() => (createPostWorkoutsRequestExercise()))}},
  ...data || {}
  }
}